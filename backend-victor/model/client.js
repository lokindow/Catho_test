class ClientModel{   
    ...
    list(){
        return new Promise(function(resolve, reject){
            ...
            mysql.exec('SELECT * FROM clients').then((data) => {
                resolve(data)
            }).catch((data) => {
                reject(data)
            })
    ...
    consult(param){
        return new Promise(function(resolve, reject){
            ...
            mysql.exec('SELECT * FROM rules WHERE client = ?', param).then((data) => {
                resolve(data)
            }).catch((data) => {
                reject(data)
            })
    ...
    insert(param){
        return new Promise(function(resolve, reject){
            ...
            mysql.exec('INSERT INTO clients SET ?', param).then((data) => {
                resolve(data)
            }).catch((data) => {
                reject(data)
            })
    ...
    update(param){
        return new Promise(function(resolve, reject){
            ...
            mysql.exec('UPDATE clients SET name = ? WHERE id = ?', param).then((data) => {
                resolve(data)
            }).catch((data) => {
                reject(data)
            })
